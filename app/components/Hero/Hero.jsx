    ...
    <div className="w-full flex flex-col lg:flex-row items-center justify-between bg-[#F2F0F1]">
      ...
      <div className="w-full lg:w-[50%] lg:pl-24">
        <div className="flex flex-col leading-[1.0] px-4 pt-10 pb-5 lg:p-0 w-full lg:w-[577px] lg:h-[173px]">
          <span className="text-[36px] md:text-[64px] font-bold inline-block uppercase">
            Find Clothes
          </span>
          <span className="text-[36px] lg:text-[64px] font-bold inline-block uppercase">
            That Matches
          </span>
          <span className="text-[36px] lg:text-[64px] font-bold inline-block uppercase">
            Your Style
        ...
        <p className="text-gray-600 text-base px-4 lg:px-0 lg:my-[32px] inline-block lg:w-[545px] lg:h-[33px]">
