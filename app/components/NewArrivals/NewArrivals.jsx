...
const NewArrivals = () => {
  ...
  return (
    <section className="w-full flex flex-col py-8 px-4  md:py-16 md:px-24 border-b">
      {isLoading ? (
          ...
          <div className="w-full py-4 flex flex-wrap lg:flex-nowrap items-center justify-center gap-12 md:gap-4">
            {data?.products?.map((product) => {
              ...
              return (
                <div
                  key={product._id}
                  className="flex flex-col items-center justify-center py-4 cursor-pointer md:w-[295px] h-[400px]"
                >
